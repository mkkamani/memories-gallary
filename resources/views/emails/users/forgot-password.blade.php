...
<head>
    ...
    <title>Reset Your Memories Password</title>
</head>
                    ...
                    <tr>
                        <td style="padding:30px 36px 20px 36px;background:#ffffff;">
                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0">
                                <tr>
                                    <td align="center">
                                        <img src="{{ $logoUrl }}" alt="Memories by Cypherox" width="300" style="display:block;height:auto;max-width:300px;">
                                    </td>
                                </tr>
                            </table>
                            <h1 style="margin:20px 0 0 0;text-align:center;font-size:26px;line-height:1.2;font-weight:800;color:#111827;">Reset Your Memories Password</h1>
                    ...
                    <tr>
                        <td style="padding:8px 36px 34px 36px;">
                            ...
                            <p style="margin:0 0 16px 0;font-size:15px;line-height:1.8;color:#374151;">
                                We received a request to reset your <b>Memories</b> account password.
                            </p>
                            ...
                            <p style="margin:0 0 22px 0;padding:12px 15px;background:#fff7ed;border:1px solid #fed7aa;border-radius:10px;font-size:15px;line-height:1.6;color:#9a3412;">
                                If you did not request this password reset, you can safely ignore this email.
                            </p>

                            <p style="margin:0 0 16px 0;font-size:15px;line-height:1.8;color:#4b5563;">Click the button below to continue:</p>

                            <table role="presentation" cellspacing="0" cellpadding="0" style="margin-top:2px;">
                                <tr>
                                    <td>
                                        <a href="{{ $resetUrl }}" style="display:inline-block;background:#ff5a1f;color:#ffffff;text-decoration:none;font-weight:700;font-size:15px;padding:12px 22px;border-radius:999px;">
                                            Reset Password
                                        </a>
                                    </td>
                                </tr>
